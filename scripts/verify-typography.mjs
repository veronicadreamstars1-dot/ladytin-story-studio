...
const explicitFiles=['index.html','package.json','vercel.json','.env.example','README.md','SUPABASE_DEPLOYMENT.md','GOOGLE_DRIVE_LIBRARY_SETUP.md','supabase/functions/shared-access/index.ts'];
...
console.log('Security and typography verification passed: monospace UI, password-only anonymous access, shared libraries, no raw password, email-auth code, removed board code, font binary or server-secret leakage.');
